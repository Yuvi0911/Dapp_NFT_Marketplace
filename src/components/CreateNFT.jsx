import {
  ...
  // const auth =
    // 'Basic ' +
    // Buffer.from(
    //   '866e10de73b64820978ab63b423d17fe' + ':' + '2XnPwgVCKe/8QEIe/cwyU0xOoaDqQQ2siwjFV3QE+lriZ/z8vxVV6A',
    // ).toString('base64')
  ...
  const CreateNFT = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const metadataURI = `https://gateway.pinata.cloud/ipfs/${responseData.IpfsHash}`
